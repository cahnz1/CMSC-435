...
public:
	...
	Fragment(double, Eigen::Vector3d);
};

class Frustum {
public:
  double h,l,r,b,t,n,f;
  //h = height
  //l = left of image
  //r = right of image
  //n = near
...
class fragShade{
public:
	Eigen::Vector3d fragShade(const Light &l, Fill &f) {
};
*/
class Fill {
public: 
...
public:
  ...
  Eigen::Vector3d getVertex(int i);
  virtual Eigen::Vector3d getNormal(int i);
...
public:
  ...
  // virtual Eigen::Vector3d normal(const Eigen::Vector3d &x) const;
	...
	Eigen::Vector3d getNormal(int i);
...
public:
  ...
  Eigen::Vector3d shade(const HitRecord &hr,const Light &l, Fill &f,const Ray &ray, int bounceLimits) const;
